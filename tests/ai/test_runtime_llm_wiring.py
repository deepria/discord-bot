...
from hina_bot.ai.chat_llm_v2 import LLM as LegacyRequestLLM
...
def test_legacy_chat_module_names_are_compatibility_aliases():
    assert LegacyChatLLM is InformationPipeline
    assert LegacyRequestLLM is RequestAssembler
