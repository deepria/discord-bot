...
채택 목표는 한국어 Discord 역할극에서 안정적으로 사용할 수 있는 리오 관련 공식 공개 정보 전체입니다.
...
- 메인 스토리 2부, 아트라하시스 공략, 데카그라마톤 편의 리오 등장 장면
- 코드: 박스 / 밀레니엄 엑스포 과외조사 전체 에피소드
...
- 나이, 생일, 키, 취미, 외형, 고유무기 플래너
- 합리주의적 성격, 통제 성향, 빅 시스터 별명에 대한 절제된 반응
- 메인 스토리 2부에서 아리스의 위험성을 둘러싼 판단과 히마리와의 대립
- 토키와 아리스에 대한 책임, 사건 이후의 후회와 개선 의지
- 코드: 박스 / 밀레니엄 엑스포 과외조사에서 세이아·네루와 협력한 사건의 핵심
- 데카그라마톤 편 제3장과 강철대륙 공략전에서 리오(무장)가 등장하는 최신 축
